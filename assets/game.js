...
loadSprite('door', 'Ou9w4gH.png');      // porta para outra fase
loadSprite('kaboom', 'o9WizfI.png');    //explosao da bomba
loadSprite('bg', 'qIXIczt.png');        // plano de fundo do jogo
loadSprite('wall-gold', 'VtTXsgH.png');
loadSprite('brick-wood', 'U751RRV.png');

// ---- bomber = bomba ---- explosion = range 4 explosao da bomba ----
